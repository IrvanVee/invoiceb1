...
@section('subhead')
<title>CRUD Data List - B One - Marketing</title>
@endsection
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="marketing-form-page" class="btn btn-primary shadow-md mr-2">Add New Marketing</a>
        {{-- <div class="dropdown">
...
<td class="table-report__action w-56">
    <div class="flex justify-center items-center">
        <a class="flex items-center mr-3" href="marketing-list-page/edit/{{ $m->id }}">
            <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit
        </a>
        <a class="flex items-center text-theme-6" href="marketing-list-page/delete/{{ $m->id }}">
