            ...
            <div class="intro-y box p-5">
                ...
                <div class="sm:grid grid-cols-2 mt-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" value="{{$invoice->discount_id}}" id="discount" placeholder="silahkan isi discount">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="tax" value="{{$invoice->tax_id}}" placeholder="silahkan isi tax" placeholder="silahkan isi tax">
                        <label class="input-group-text" for="inputGroupSelect02">%</label>
                    </div>
                    {{-- end div --}}
                </div>
