...
@section('subhead')
    <title>Dashboard - B One - Admin</title>
@endsection
    ...
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 xxl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                {{-- BEGIN: SHORTCUT BUTTON --}}
                <div class="col-span-12 m:col-span-6 lg:col-span-3 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Shortcut Button</h2>
                    </div>
                    <div class="intro-y box p-5 mt-5 ">
                        <div class="mt-8">
                            <div class="row">
                                <div class="col">
                                    <div class="flex items-center mt-4">
                                        <a href="/invoice-form-page"><button type="button" class="btn btn-outline-primary mr-4">Add Invoice</button></a>
                                        <a href="/invoice-list-page"><button type="button" class="btn btn-outline-primary ">Invoice List</button></a>
                                    </div>  
                                </div>
                                <div class="col">
                                    <div class="flex items-center mt-4">
                                        <a href="/quote-form-page" type="button" class="btn btn-outline-primary mr-4">Add Quotation</a>
                                        <a href="/quote-list-page" type="button" class="btn btn-outline-primary">Quote List</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center mt-4">
                                <a href="product-form-page" type="button" class="btn btn-outline-danger mr-4">Add Product</a>
                                <a href="product-list-page" type="button" class="btn btn-outline-danger">Product List</a>
                            </div>
                            <div class="flex items-center mt-4">
                                <a href="customers-form-page" type="button" class="btn btn-outline-danger mr-4">Add Customer</a>
                                <a href="customers-list-page" type="button" class="btn btn-outline-danger ">Customers list</a>
                            </div>
                            <div class="flex items-center mt-4">
                                <a href="users-form-page" type="button" class="btn btn-outline-danger mr-4">Add User</a>
                                <a href="users-list-page" type="button" class="btn btn-outline-danger ">User list</a>
                            </div>
                            <div class="flex items-center mt-4">
                                <a href="tax-form-page" type="button" class="btn btn-outline-danger mr-4">Input Tax</a>
                                <a href="tax-list-page" type="button" class="btn btn-outline-danger ">Tax List</a>
                            </div>
                        </div>
                    </div>
                </div>
