...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="role-form" class="btn btn-primary shadow-md mr-2">Add New Role</a>
            {{-- <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center mr-3" href="role-edit/edit/{{ $role->id }}">
                                    <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit
                                </a>
                                {{-- <a class="flex items-center text-theme-6" href="users-list-page/delete/{{ $u->id }}">
                                    <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete
                                </a> --}}
                                <form action="/role-list/delete/{{ $role->id }}" onsubmit="return confirm('are you sure')" method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                    <td style="color: red;text-align:center;" colspan="3">tidak ada role</td>
                    @endforelse
                    {{-- @endforeach --}}
                </tbody>
            </table>
