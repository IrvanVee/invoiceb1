...
@section('subhead')
    <title>CRUD Data List - B One - Customers</title>
@endsection
...
@endif
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="customers-form-page" class="btn btn-primary shadow-md mr-2">Add New Customer</a>
            {{-- <div class="dropdown">
                ...
                <tbody>
                    ...
                    @foreach ($customer as $c)
                        <tr class="intro-x ">
                            ...
                            <td>
                                <div><a href="" class="text-gray-600 font-medium whitespace-nowrap">{{ $c->instance }}</a></div>
                                {{-- <div class=" text-xs whitespace-nowrap mt-0.5">{{ $faker['products'][0]['category'] }}</div> --}}
                            </td>
